	...
	["esES"] = 
{
	...
	["chat:addon-is-disabled-note"] = "Tenga en cuenta: este addon está deshabilitado. Puede habilitarlo en la opción de diálogo (/nc)",
...
(comma-separated)]=],
	...
	["Profiles"] = "Perfis",
	["Show border around interrupts"] = "Mostrar borda em interrupts",
	["Show border around trinkets"] = "Mostrar borda em trinkets",
