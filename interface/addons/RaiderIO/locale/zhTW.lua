...
L["API_DEPRECATED"] = "|cffFF0000警告！|r此插件 |cffFFFFFF%s|r 正調用一個已棄用的函數RaiderIO.%s。此功能將在以後的版本中刪除。 請鼓勵％s的作者更新他們的插件。 調用堆疊：％s"
L["API_DEPRECATED_UNKNOWN_ADDON"] = "<未知插件>"
L["API_DEPRECATED_UNKNOWN_FILE"] = "<未知插件檔案>"
L["API_DEPRECATED_WITH"] = "|cffFF0000警告！|r此插件 |cffFFFFFF%s|r 正調用一個已棄用的函數RaiderIO.%s。此功能將在以後的版本中刪除。 請鼓勵％s的作者更新到新的API RaiderIO.%s。調用堆疊：%"
