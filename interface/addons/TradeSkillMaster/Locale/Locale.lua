...
TSM.L["TSM_Accounting detected that you just traded %s %s in return for %s. Would you like Accounting to store a record of this trade?"] = "TSM_Accounting hat festgestellt, dass du gerade %s %s gegen %s getauscht hast. Möchtest du, dass die Buchhaltung eine Aufzeichnung dieses Handels speichert?"
TSM.L["TSM4"] = "TSM4"
