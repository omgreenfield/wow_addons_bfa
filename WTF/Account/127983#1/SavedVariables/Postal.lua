...
Postal3DB = {
	...
	["global"] = {
		["BlackBook"] = {
			["alts"] = {
				"Eyebrowse|Kel'Thuzad|Alliance|120|DRUID", -- [1]
				"Fistbeavers|Kel'Thuzad|Alliance|120|MONK", -- [2]
				"Suhdrude|Anvilmar|Alliance|110|DRUID", -- [3]
				"Twiddlederr|Anvilmar|Alliance|120|DEMONHUNTER", -- [4]
				"Twiddlederr|Kel'Thuzad|Alliance|120|DEMONHUNTER", -- [5]
			},
		},
	},
	["profiles"] = {
		["Twiddlederr - Kel'Thuzad"] = {
			["BlackBook"] = {
				["recent"] = {
					"Eyebrowse|Kel'Thuzad|Alliance", -- [1]
